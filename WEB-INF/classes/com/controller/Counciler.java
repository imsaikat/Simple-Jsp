...
/**
 * Servlet implementation class Counciler
 */
@WebServlet("/Counciler")
public class Counciler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher reqestDispatcher =request.getRequestDispatcher("Counciler.jsp");
