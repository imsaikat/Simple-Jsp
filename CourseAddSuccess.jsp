...
<html lang="en" class="no-js">
	...
	<div class="container" style = "padding : 0;">
    	...
    	<%
		Course crse = (Course) request.getAttribute("coursekey");
		%>
		<div class="container">
			<header class="codrops-header">
				<h1>One Course Is Successfully Added .</h1>
                <div id="table">
                	<table align="center" cellpadding="20">
                        ...
                        <tr>
                            <td><%=crse.getCourseId() %></td>
                            <td><%=crse.getCourseName() %></td>
                            <td><%=crse.getDuration() %></td>
                            <td><%=crse.getSchedule() %></td>
                            <td><%=crse.getStartDate() %></td>
                            <td><%=crse.getEndDate() %></td>
                            <td><%=crse.getCapacity() %></td>
                        </tr>                
                    </table>
